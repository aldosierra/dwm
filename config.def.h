...
static const Rule rules[] = {
	...
	{ NULL,      NULL,     "st",           0,         0,          1,           0,        -1,        0 },
	{ NULL,      NULL,     "Event Tester", 0,         0,          0,           1,        -1,        0 }, /* xev */
	{ NULL,       NULL,   "scratchpad",    0,            1,        1,           0,        -1,       's' },
	{ NULL,       NULL,   "pamixer",       0,            1,        1,           0,        -1,       'p' },
    { NULL,      NULL,      "btmgr",       0,         1,          1,           0,        -1,        0 },
    { NULL,      NULL,      "Microsoft Teams Notification",       0,         1,          0,           0,        -1,        0 },
    { "Zathura",      NULL,     NULL,       0,         1,          0,           0,        -1,        0 },
};
...
static const char *pamixercmd[] = {"p", "st", "-t", "pamixer", "-g", "120x34", "-e", "pulsemixer", NULL}; 
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_u,      togglescratch,  {.v = pamixercmd } },
